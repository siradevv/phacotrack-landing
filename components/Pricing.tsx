...
const proBullets = [
  ...
  "Full analytics dashboard (6 modules)",
  "SIA calculator & personalised A-constant",
  "CSV & PDF export",
  ...
  return (
    <SectionWrapper id="pricing" alt>
        ...
        <AnimateOnScroll>
          <div className="flex h-full flex-col rounded-2xl border border-line bg-surface px-7 py-8">
            ...
            <div className="mt-4 flex items-baseline gap-1">
              <span className="text-[2.5rem] font-bold leading-none text-ink">
                $0
              </span>
        ...
        <AnimateOnScroll delay={120}>
          <div className="relative flex h-full flex-col rounded-2xl border-2 border-accent bg-surface px-7 py-8 shadow-[0_8px_30px_-8px_rgba(42,122,223,0.15)]">
            ...
            <p className="mt-1.5 text-[14px] text-ink-muted">
              or $79.99/year{" "}
              <span className="font-semibold text-positive">save 33%</span>
            </p>
      ...
      <p className="mt-8 text-center text-[13px] text-ink-faint">
        Pricing shown in USD. Local pricing may vary by region. Prices are
        subject to change.
      </p>
    </SectionWrapper>
  );
